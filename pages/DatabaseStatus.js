...
const DatabaseStatus = (props) => {  
  ...
  const getDatabaseStatus = async() => {
    ...
    */       
    ...
    let selectQuery2 = await ExecuteQuery(sql2,[]);
    comment = "";
    d1.push(["Teams",selectQuery2.rows.length,comment]);
    
    //Matches
    let sql3 = "SELECT * from Matches ";
    let selectQuery3 = await ExecuteQuery(sql3,[]);
    comment = "";
    ...
    let selectQuery4 = await ExecuteQuery(sql4,[]);
    ...
    let selectQuery5 = await ExecuteQuery(sql5,[]);
      ...
      <ScrollView horizontal={true}>
        <View>
          ...
          <ScrollView style={styles.dataWrapper}>
            ...
            <ActionButton title="Refresh" customClick={refresh_database} > 
            </ActionButton>
          </ScrollView>
        </View>
      </ScrollView>
